...
use zplonk::utils::serialization::{ark_serialize, ark_deserialize};
...
pub  struct  CryptoCard(#[serde(serialize_with = "ark_serialize", deserialize_with = "ark_deserialize")] pub   zshuffle::Card);

/// An reveal part card
pub type RevealCard = CryptoCard;
